...
if __name__ == "__main__":
    ...
    ha_train, s_train, ha_val, s_val = dataset.load_features()
    h_train, a_train = ha_train
    h_val, a_val = ha_val
    
    train_data_loader = dataset.make_data_loader([h_train, a_train], s_train, ommit_unrelateds=True)
    val_data_loader = dataset.make_data_loader([h_val, a_val], s_val, ommit_unrelateds=True)
